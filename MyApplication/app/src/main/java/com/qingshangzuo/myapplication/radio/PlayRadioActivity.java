package com.qingshangzuo.myapplication.radio;
...
import static com.qingshangzuo.myapplication.radio.RecordView.MODEL_PLAY;

public class PlayRadioActivity extends AppCompatActivity implements View.OnTouchListener, View.OnClickListener {
        ...
        if(event.getAction() == MotionEvent.ACTION_DOWN){
            ...
            mRecorfView.setOnCountDownListener(new RecordView.OnCountDownListener() {
                ...
                public void onCountDown() {
                    Toast.makeText(PlayRadioActivity.this,"计时结束啦~~",Toast.LENGTH_SHORT).show();
                }
            });
